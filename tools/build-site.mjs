...
const company = {
  ...
  priceRange: "₾₾",
  hours: "Ежедневно 07:00-23:00, срочные заказы 24/7",
...
const homePages = {
  ru: {
    ...
    pricesText: "Каждый заказ рассчитывается под задачу: маршрут, объем, этаж, грузчики, упаковка и ожидание. Минимальная городская перевозка указана от 50 ₾, точную цену лучше уточнить после описания груза.",
    processTitle: "Как проходит перевозка",
    processText: "Перед подачей машины уточняем детали, чтобы приехать с подходящим фургоном, нужным количеством грузчиков и понятным расчетом.",
    whyTitle: "Почему выбирают BoxMove",
    whyText: "Мы заранее уточняем объем, этаж, лифт, хрупкие вещи и маршрут. Приезжаем вовремя, закрепляем груз в кузове и держим связь до завершения заказа.",
    ...
    quoteText: "Форма открывает готовое сообщение в WhatsApp. Добавьте адреса, тип груза и количество грузчиков, чтобы быстрее получить расчет.",
    contactsTitle: "Напишите BoxMove - подберем машину и время",
    ...
    faq: [
      ["Сколько стоит грузоперевозка по Тбилиси?", "Минимальная стоимость в текущем контенте сайта указана от 50 ₾. Итоговая цена зависит от маршрута, объема груза, этажа, лифта, количества грузчиков, упаковки и ожидания."],
  ...
  en: {
    ...
    h1: "BoxMove moves furniture, boxes and bulky cargo with care",
  ...
  ka: {
    ...
    h1: "BoxMove ფრთხილად გადაიტანს ნივთებს, ავეჯს და დიდ ტვირთს",
...
const serviceCards = [
  ["Грузоперевозки в Тбилиси", "Фургон, водитель и грузчики для мебели, техники, вещей и коммерческих грузов.", "/ru/gruzoperevozki-tbilisi/", "/assets/boxmove-tbilisi-van.webp", "Фургон BoxMove для грузоперевозок в Тбилиси"],
  ["Грузовое такси", "Быстрая подача машины для коробок, покупок, оборудования и небольших грузов.", "/ru/gruzovoe-taksi-tbilisi/", "/assets/service-taxi.svg", "Фургон BoxMove для грузового такси по Тбилиси"],
  ["Перевозка мебели", "Аккуратная погрузка, размещение в кузове и доставка мебели по нужному адресу.", "/ru/perevozka-mebeli-tbilisi/", "/assets/service-turnkey.svg", "Погрузка мебели при квартирном переезде"],
  ["Разборка и сборка мебели", "Разберем крупную мебель перед перевозкой и соберем ее на новом адресе по согласованию.", "/ru/razborka-sborka-mebeli-tbilisi/", "/assets/service-assembly.svg", "Разборка и сборка мебели перед перевозкой"],
  ["Квартирный переезд", "Перевозка мебели, техники, коробок и личных вещей с помощью грузчиков.", "/ru/kvartirny-pereezd-tbilisi/", "/assets/service-packing.svg", "Перевозка коробок и бытовой техники"],
  ["Офисный переезд", "Перевозка столов, кресел, техники, документов и имущества компании.", "/ru/ofisny-pereezd-tbilisi/", "/assets/service-office.svg", "Офисный переезд с мебелью и техникой"],
  ["Услуги грузчиков", "Погрузка, разгрузка, подъем на этаж и переноска мебели, техники и коробок.", "/ru/gruzchiki-tbilisi/", "/assets/service-loaders.svg", "Грузчики BoxMove переносят мебель и коробки"],
  ["Вывоз мусора", "Вывоз строительного мусора, старой мебели и ненужных вещей после ремонта или переезда.", "/ru/vyvoz-musora-tbilisi/", "/assets/service-junk.svg", "Вывоз мусора BoxMove после ремонта и переезда"],
  ["Грузоперевозки по Грузии", "Междугородние перевозки из Тбилиси в другие города Грузии.", "/ru/gruzoperevozki-po-gruzii/", "/assets/service-intercity.svg", "Фургон на маршруте по Грузии"]
];
...
const servicePages = [
  {
    ...
    detail: "Услуга подходит для разовых перевозок, переездов, доставки покупок, перевозки товара между адресами и маршрутов из Тбилиси по Грузии. Перед заказом мы уточняем объем, вес, этаж, лифт, необходимость упаковки и количество адресов, чтобы расчет был понятным.",
  ...
  },
  {
    ...
    cost: "Цена зависит от маршрута, времени работы, размера груза и необходимости грузчиков. Минимальный ориентир городского заказа вынесен в общий конфиг сайта.",
    advantages: ["быстрая городская подача", "подходит для небольших грузов", "можно добавить грузчика", "расчет до выезда"],
  ...
  },
  {
    ...
    image: "/assets/service-turnkey.svg",
    imageAlt: "Перевозка мебели и коробок в Тбилиси"
  },
  {
    ...
    steps: ["Отправьте фото мебели и опишите, что нужно разобрать.", "Мы уточним размеры, крепеж, этаж, лифт и адрес сборки.", "Команда разберет мебель и подготовит элементы к погрузке.", "После перевозки мебель можно собрать на новом месте по согласованию."],
    ...
    advantages: ["удобно добавлять к переезду", "помогает перевезти крупную мебель", "упаковку деталей можно обсудить заранее", "расчет по реальному объему работ"],
    ...
    image: "/assets/service-assembly.svg",
  ...
  },
  {
    ...
    cost: "Цена квартирного переезда зависит от объема вещей, количества грузчиков, этажей, лифта, упаковки, разборки мебели и расстояния между адресами. Расчет делается после уточнения деталей.",
    advantages: ["команда под объем вещей", "погрузка и выгрузка", "упаковка по запросу", "разборка и сборка мебели"],
    faq: [["Можно ли заказать переезд под ключ?", "Да, можно обсудить упаковку, разборку мебели, перевозку, разгрузку и сборку на новом месте."], ["Сколько грузчиков нужно для квартиры?", "Это зависит от объема вещей, этажей, лифта и крупной мебели. Количество лучше определить после описания переезда."], ["Можно ли переехать вечером или в выходной?", "Да, время обсуждается заранее. На сайте указан ежедневный график 07:00-23:00."]],
    related: ["perevozka-mebeli-tbilisi", "razborka-sborka-mebeli-tbilisi", "gruzchiki-tbilisi"],
    image: "/assets/service-packing.svg",
    imageAlt: "Квартирный переезд с упаковкой BoxMove"
  },
  {
    ...
    steps: ["Опишите объем офиса и желаемое время переезда.", "Уточните доступ к зданию, лифт, парковку и этажи.", "Мы согласуем фургон, грузчиков и порядок работ.", "Имущество загружается, перевозится и выгружается на новом адресе."],
    cost: "Стоимость зависит от объема мебели и техники, количества адресов, этажей, лифта, времени работы команды, упаковки и необходимости разборки мебели.",
    advantages: ["перевозка техники и мебели", "работа в согласованное время", "грузчики по запросу", "расчет по реальному объему"],
    faq: [["Перевозите ли вы офисную технику?", "Да, перевозим технику и оборудование, если заранее известны размеры, вес и требования к переноске."], ["Можно ли переехать вечером?", "Да, время можно согласовать заранее с учетом графика команды и доступа к зданию."], ["Помогаете ли с разборкой офисной мебели?", "Разборку и сборку мебели можно обсудить при расчете заказа."]],
    related: ["gruzchiki-tbilisi", "razborka-sborka-mebeli-tbilisi", "gruzoperevozki-tbilisi"],
    image: "/assets/service-office.svg",
    imageAlt: "Офисный переезд с мебелью и техникой"
  },
  {
    ...
    cost: "Стоимость зависит от числа грузчиков, времени работы, веса предметов, этажей, наличия лифта и сложности переноски. Точный расчет делается после описания задачи.",
  ...
  },
  {
    ...
    detail: "Мы не заявляем официальную утилизацию отходов без подтвержденных документов. Услуга описывает погрузку и транспортировку ненужных вещей или мусора подходящим автомобилем после согласования объема и адреса.",
    ...
    steps: ["Опишите тип и примерный объем мусора или вещей.", "Уточните адрес, этаж, лифт и возможность подъезда.", "Мы согласуем автомобиль, грузчиков и время.", "Команда погрузит и вывезет согласованный объем."],
    cost: "Цена зависит от объема, веса, этажей, необходимости грузчиков, времени работы и маршрута. Фиксированная стоимость без осмотра или описания объема не указывается.",
    advantages: ["погрузка по запросу", "подходит для старой мебели и вещей", "расчет по объему и сложности", "работа по Тбилиси"],
    faq: [["Вы занимаетесь официальной утилизацией?", "В проекте нет подтвержденных данных об официальной утилизации, поэтому услуга описана как погрузка и транспортировка мусора или ненужных вещей."], ["Можно ли вывезти старую мебель?", "Да, можно обсудить вывоз старой мебели, если заранее известен объем, этаж и нужна ли разборка."], ["Нужны ли грузчики?", "Если мусор или мебель нужно вынести из помещения, грузчиков лучше добавить при заказе."]],
    related: ["gruzchiki-tbilisi", "gruzovoe-taksi-tbilisi", "gruzoperevozki-tbilisi"],
    image: "/assets/service-junk.svg",
    imageAlt: "Вывоз мусора BoxMove после ремонта и переезда"
  },
  {
    ...
    detail: "Маршруты по Грузии требуют предварительного расчета по расстоянию, объему, весу и срокам. Мы уточняем адреса, удобное время выезда, особенности груза и необходимость грузчиков на каждом адресе.",
    ...
    steps: ["Сообщите город отправления, город доставки и адреса.", "Опишите груз, вес, объем и необходимость грузчиков.", "Мы согласуем маршрут, время выезда и расчет.", "Груз доставляется по адресу, а команда остается на связи в пути."],
    cost: "Стоимость междугородней перевозки зависит от расстояния, объема и веса груза, времени выезда, ожидания и погрузочно-разгрузочных работ. Цена рассчитывается индивидуально.",
    ...
    faq: [["В какие города вы ездите?", "В текущем контенте указаны маршруты по всей Грузии, включая Батуми, Кутаиси и Рустави. Конкретный город лучше уточнить перед заказом."], ["Как считается цена по Грузии?", "Учитываются расстояние, объем, вес, время выезда, ожидание, этажи и необходимость грузчиков."], ["Можно ли заказать междугородний переезд?", "Да, можно обсудить перевозку мебели, техники, коробок и личных вещей из Тбилиси в другой город."]],
    related: ["gruzoperevozki-tbilisi", "kvartirny-pereezd-tbilisi", "gruzovoe-taksi-tbilisi"],
    image: "/assets/service-intercity.svg",
    imageAlt: "Фургон на маршруте по Грузии"
  }
];
...
const ui = {
  ru: {
    ...
    floatingCall: "Звонок",
    priceCards: [
      ["Грузовое такси", "Городская подача", "Когда нужно быстро перевезти вещи по Тбилиси", ["Фургон с водителем", "Подача по району", "Расчет до выезда"]],
      ...
      ["Межгород", "Маршрут по Грузии", "Тбилиси - Батуми, Кутаиси, Рустави и другие города", ["Согласованное время выезда", "Расчет по маршруту", "Связь в пути"]]
    ],
    processSteps: [
      "Вы отправляете адреса, фото или описание груза и желаемое время.",
      "Мы уточняем объем, этаж, лифт, необходимость упаковки и грузчиков.",
  ...
  en: {
    ...
    contactHours: "Hours",
    hoursValue: "Daily 07:00-23:00, urgent orders 24/7",
    floatingLabel: "Quick contact with BoxMove",
    whatsappAria: "Message BoxMove on WhatsApp",
    telegramAria: "Message BoxMove on Telegram",
    floatingCall: "Call",
    priceCards: [
      ["Cargo taxi", "City dispatch", "For quick transport around Tbilisi", ["Van with driver", "Up to 1 hour of work", "Local pickup"]],
  ...
  ka: {
    ...
    contactHours: "დრო",
    hoursValue: "ყოველდღე 07:00-23:00, სასწრაფო შეკვეთები 24/7",
    ...
    floatingCall: "ზარი",
    priceCards: [
      ["სატვირთო ტაქსი", "ქალაქში გამოძახება", "როცა ნივთების სწრაფად გადატანა გჭირდებათ თბილისში", ["ფურგონი მძღოლით", "1 საათამდე მუშაობა", "ადგილობრივი მიწოდება"]],
...
function serviceGrid(lang) {
  const copy = ui[lang] || ui.ru;
  if (lang !== "ru") {
    const page = homePages[lang];
    const labels = lang === "en"
      ? [["Furniture and appliance moving", "Sofas, wardrobes, fridges, washing machines and other bulky items.", "/assets/service-turnkey.svg"], ["Furniture disassembly and assembly", "Large furniture can be prepared before moving and assembled at the new address.", "/assets/service-assembly.svg"], ["Cargo taxi in Tbilisi", "Fast van dispatch for boxes, purchases, equipment and goods.", "/assets/service-taxi.svg"], ["Loaders and packing", "Carrying by stairs, wrapping film, cardboard and careful loading.", "/assets/service-loaders.svg"], ["Junk removal", "Removal of renovation waste, old furniture and unwanted items.", "/assets/service-junk.svg"]]
      : [["ავეჯის და ტექნიკის გადატანა", "დივნები, კარადები, მაცივრები და დიდი ნივთები.", "/assets/service-turnkey.svg"], ["ავეჯის დაშლა და აწყობა", "დიდი ავეჯის მომზადება გადატანამდე და აწყობა ახალ მისამართზე.", "/assets/service-assembly.svg"], ["სატვირთო ტაქსი თბილისში", "სწრაფი მანქანა ყუთებისთვის, შენაძენებისთვის და ტექნიკისთვის.", "/assets/service-taxi.svg"], ["მტვირთავები და შეფუთვა", "ატანა, ჩამოტანა, ფირი, მუყაო და ფრთხილი ჩატვირთვა.", "/assets/service-loaders.svg"], ["ნარჩენების გატანა", "სამშენებლო ნარჩენები, ძველი ავეჯი და ზედმეტი ნივთები.", "/assets/service-junk.svg"]];
      ...
      <section class="hero" aria-labelledby="hero-title">
        ...
        <div class="container hero-inner">
          ...
          <aside class="hero-status" data-reveal aria-label="Availability">
            ...
            <div class="status-line"><span>${esc(page.city)}</span><strong>24/7</strong></div>
          </aside>
        </div>
      </section>
...
${head(page, schemas)}
  <body data-page-lang="ru">
    ...
    <main id="top">
      ...
      <section class="section quote-section" id="quote"><div class="container quote-layout"><div class="quote-copy" data-reveal><p class="eyebrow">Заказ</p><h2>Заказать ${esc(service.h1.toLowerCase())}</h2><p>Форма откроет готовое сообщение в WhatsApp. Можно также позвонить или написать в Telegram.</p><div class="estimate-box"><span>Ориентир:</span><strong data-estimate>50 ₾</strong><p>Точная цена после уточнения деталей</p></div></div>${quoteForm(homePages.ru)}</div></section>
